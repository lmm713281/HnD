<%@ Page language="c#" AutoEventWireup="false" Inherits="SD.HnD.GUI.Admin.AddUsersToRole" 
	MasterPageFile="~/Admin/AdminMaster.master" Title="HnD::Administrate::Add users to role" Codebehind="AddUsersToRole.aspx.cs" %>
