...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _thread, new PropertyChangedEventHandler(OnThreadPropertyChanged), "Thread", "Messages", SD.HnD.DAL.RelationClasses.StaticMessageRelations.ThreadEntityUsingThreadIDStatic, true, new int[] { (int)MessageFieldIndex.ThreadID });
		}
		...
		{
			SetupSync(relatedEntity, ref _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", "Messages", SD.HnD.DAL.RelationClasses.StaticMessageRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  }, new int[] { (int)MessageFieldIndex.ThreadID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _postedByUser, new PropertyChangedEventHandler(OnPostedByUserPropertyChanged), "PostedByUser", "PostedMessages", SD.HnD.DAL.RelationClasses.StaticMessageRelations.UserEntityUsingPostedByUserIDStatic, true, new int[] { (int)MessageFieldIndex.PostedByUserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _postedByUser, new PropertyChangedEventHandler( OnPostedByUserPropertyChanged ), "PostedByUser", "PostedMessages", SD.HnD.DAL.RelationClasses.StaticMessageRelations.UserEntityUsingPostedByUserIDStatic, true, new string[] {  }, new int[] { (int)MessageFieldIndex.PostedByUserID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditDataMessageRelatedEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditDataMessageRelatedEntityFactory))), (IEntityRelation)GetRelationsForField("AuditDataMessageRelated")[0], (int)SD.HnD.DAL.EntityType.MessageEntity, (int)SD.HnD.DAL.EntityType.AuditDataMessageRelatedEntity, 0, null, null, null, null, "AuditDataMessageRelated", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.MessageEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("PostedByUser")[0], (int)SD.HnD.DAL.EntityType.MessageEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "PostedByUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
