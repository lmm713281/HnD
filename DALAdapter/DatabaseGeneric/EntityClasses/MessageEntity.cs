...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class MessageEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("MessageEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.MessageEntity, typeof(MessageEntity), typeof(MessageEntityFactory), false);
				AddNavigatorMetaData<MessageEntity, EntityCollection<AttachmentEntity>>("Attachments", a => a._attachments, (a, b) => a._attachments = b, a => a.Attachments, () => new MessageRelations().AttachmentEntityUsingMessageID, typeof(AttachmentEntity), (int)SD.HnD.DAL.EntityType.AttachmentEntity);
				AddNavigatorMetaData<MessageEntity, EntityCollection<AuditDataMessageRelatedEntity>>("AuditDataMessageRelated", a => a._auditDataMessageRelated, (a, b) => a._auditDataMessageRelated = b, a => a.AuditDataMessageRelated, () => new MessageRelations().AuditDataMessageRelatedEntityUsingMessageID, typeof(AuditDataMessageRelatedEntity), (int)SD.HnD.DAL.EntityType.AuditDataMessageRelatedEntity);
				AddNavigatorMetaData<MessageEntity, ThreadEntity>("Thread", "Messages", (a, b) => a._thread = b, a => a._thread, (a, b) => a.Thread = b, SD.HnD.DAL.RelationClasses.StaticMessageRelations.ThreadEntityUsingThreadIDStatic, ()=>new MessageRelations().ThreadEntityUsingThreadID, null, new int[] { (int)MessageFieldIndex.ThreadID }, null, true, (int)SD.HnD.DAL.EntityType.ThreadEntity);
				AddNavigatorMetaData<MessageEntity, UserEntity>("PostedByUser", "PostedMessages", (a, b) => a._postedByUser = b, a => a._postedByUser, (a, b) => a.PostedByUser = b, SD.HnD.DAL.RelationClasses.StaticMessageRelations.UserEntityUsingPostedByUserIDStatic, ()=>new MessageRelations().UserEntityUsingPostedByUserID, null, new int[] { (int)MessageFieldIndex.PostedByUserID }, null, true, (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "Message"."MessageTextAsXml".<br/>Table field type characteristics (type, precision, scale, length): NText, 0, 0, 1073741823.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
