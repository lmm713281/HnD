...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class BookmarkEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("BookmarkEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.BookmarkEntity, typeof(BookmarkEntity), typeof(BookmarkEntityFactory), false);
				AddNavigatorMetaData<BookmarkEntity, ThreadEntity>("Thread", "PresentInBookmarks", (a, b) => a._thread = b, a => a._thread, (a, b) => a.Thread = b, SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.ThreadEntityUsingThreadIDStatic, ()=>new BookmarkRelations().ThreadEntityUsingThreadID, null, new int[] { (int)BookmarkFieldIndex.ThreadID }, null, true, (int)SD.HnD.DAL.EntityType.ThreadEntity);
				AddNavigatorMetaData<BookmarkEntity, UserEntity>("User", "Bookmarks", (a, b) => a._user = b, a => a._user, (a, b) => a.User = b, SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, ()=>new BookmarkRelations().UserEntityUsingUserID, null, new int[] { (int)BookmarkFieldIndex.UserID }, null, true, (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
