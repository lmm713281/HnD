...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _thread, new PropertyChangedEventHandler(OnThreadPropertyChanged), "Thread", "PresentInBookmarks", SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.ThreadEntityUsingThreadIDStatic, true, new int[] { (int)BookmarkFieldIndex.ThreadID });
		}
		...
		{
			SetupSync(relatedEntity, ref _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", "PresentInBookmarks", SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  }, new int[] { (int)BookmarkFieldIndex.ThreadID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "Bookmarks", SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, true, new int[] { (int)BookmarkFieldIndex.UserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "Bookmarks", SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, true, new string[] {  }, new int[] { (int)BookmarkFieldIndex.UserID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.BookmarkEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DAL.EntityType.BookmarkEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
