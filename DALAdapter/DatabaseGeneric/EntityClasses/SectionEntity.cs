...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SectionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SectionEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.SectionEntity, typeof(SectionEntity), typeof(SectionEntityFactory), false);
				AddNavigatorMetaData<SectionEntity, EntityCollection<ForumEntity>>("Forums", a => a._forums, (a, b) => a._forums = b, a => a.Forums, () => new SectionRelations().ForumEntityUsingSectionID, typeof(ForumEntity), (int)SD.HnD.DAL.EntityType.ForumEntity);
			}
		}
