...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))), (IEntityRelation)GetRelationsForField("Forums")[0], (int)SD.HnD.DAL.EntityType.SectionEntity, (int)SD.HnD.DAL.EntityType.ForumEntity, 0, null, null, null, null, "Forums", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
