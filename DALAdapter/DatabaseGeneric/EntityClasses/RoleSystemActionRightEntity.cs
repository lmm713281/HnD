...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RoleSystemActionRightEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RoleSystemActionRightEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.RoleSystemActionRightEntity, typeof(RoleSystemActionRightEntity), typeof(RoleSystemActionRightEntityFactory), false);
				AddNavigatorMetaData<RoleSystemActionRightEntity, ActionRightEntity>("ActionRight", "RoleSystemActionRights", (a, b) => a._actionRight = b, a => a._actionRight, (a, b) => a.ActionRight = b, SD.HnD.DAL.RelationClasses.StaticRoleSystemActionRightRelations.ActionRightEntityUsingActionRightIDStatic, ()=>new RoleSystemActionRightRelations().ActionRightEntityUsingActionRightID, null, new int[] { (int)RoleSystemActionRightFieldIndex.ActionRightID }, null, true, (int)SD.HnD.DAL.EntityType.ActionRightEntity);
				AddNavigatorMetaData<RoleSystemActionRightEntity, RoleEntity>("Role", "RoleSystemActionRights", (a, b) => a._role = b, a => a._role, (a, b) => a.Role = b, SD.HnD.DAL.RelationClasses.StaticRoleSystemActionRightRelations.RoleEntityUsingRoleIDStatic, ()=>new RoleSystemActionRightRelations().RoleEntityUsingRoleID, null, new int[] { (int)RoleSystemActionRightFieldIndex.RoleID }, null, true, (int)SD.HnD.DAL.EntityType.RoleEntity);
			}
		}
