...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _forum, new PropertyChangedEventHandler(OnForumPropertyChanged), "Forum", "Threads", SD.HnD.DAL.RelationClasses.StaticThreadRelations.ForumEntityUsingForumIDStatic, true, new int[] { (int)ThreadFieldIndex.ForumID });
		}
		...
		{
			SetupSync(relatedEntity, ref _forum, new PropertyChangedEventHandler( OnForumPropertyChanged ), "Forum", "Threads", SD.HnD.DAL.RelationClasses.StaticThreadRelations.ForumEntityUsingForumIDStatic, true, new string[] {  }, new int[] { (int)ThreadFieldIndex.ForumID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _userWhoStartedThread, new PropertyChangedEventHandler(OnUserWhoStartedThreadPropertyChanged), "UserWhoStartedThread", "StartedThreads", SD.HnD.DAL.RelationClasses.StaticThreadRelations.UserEntityUsingStartedByUserIDStatic, true, new int[] { (int)ThreadFieldIndex.StartedByUserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _userWhoStartedThread, new PropertyChangedEventHandler( OnUserWhoStartedThreadPropertyChanged ), "UserWhoStartedThread", "StartedThreads", SD.HnD.DAL.RelationClasses.StaticThreadRelations.UserEntityUsingStartedByUserIDStatic, true, new string[] {  }, new int[] { (int)ThreadFieldIndex.StartedByUserID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _supportQueueThread, new PropertyChangedEventHandler(OnSupportQueueThreadPropertyChanged), "SupportQueueThread", "Thread", SD.HnD.DAL.RelationClasses.StaticThreadRelations.SupportQueueThreadEntityUsingThreadIDStatic, false, new int[] { (int)ThreadFieldIndex.ThreadID });
		}
		...
		{
			SetupSync(relatedEntity, ref _supportQueueThread, new PropertyChangedEventHandler( OnSupportQueueThreadPropertyChanged ), "SupportQueueThread", "Thread", SD.HnD.DAL.RelationClasses.StaticThreadRelations.SupportQueueThreadEntityUsingThreadIDStatic, false, new string[] {  }, new int[] { (int)ThreadFieldIndex.ThreadID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BookmarkEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BookmarkEntityFactory))), (IEntityRelation)GetRelationsForField("PresentInBookmarks")[0], (int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.BookmarkEntity, 0, null, null, null, null, "PresentInBookmarks", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<MessageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MessageEntityFactory))), (IEntityRelation)GetRelationsForField("Messages")[0], (int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.MessageEntity, 0, null, null, null, null, "Messages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUsersWhoBookmarkedThread
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, GetRelationsForField("UsersWhoBookmarkedThread"), null, "UsersWhoBookmarkedThread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUsersWhoPostedInThread
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, GetRelationsForField("UsersWhoPostedInThread"), null, "UsersWhoPostedInThread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUsersWhoSubscribedThread
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, GetRelationsForField("UsersWhoSubscribedThread"), null, "UsersWhoSubscribedThread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))),	(IEntityRelation)GetRelationsForField("Forum")[0], (int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.ForumEntity, 0, null, null, null, null, "Forum", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("UserWhoStartedThread")[0], (int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "UserWhoStartedThread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SupportQueueThreadEntityFactory))), (IEntityRelation)GetRelationsForField("SupportQueueThread")[0], (int)SD.HnD.DAL.EntityType.ThreadEntity, (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, 0, null, null, null, null, "SupportQueueThread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
