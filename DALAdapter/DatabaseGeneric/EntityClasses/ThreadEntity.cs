...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ThreadEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ThreadEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.ThreadEntity, typeof(ThreadEntity), typeof(ThreadEntityFactory), false);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<AuditDataThreadRelatedEntity>>("AuditDataThreadRelated", a => a._auditDataThreadRelated, (a, b) => a._auditDataThreadRelated = b, a => a.AuditDataThreadRelated, () => new ThreadRelations().AuditDataThreadRelatedEntityUsingThreadID, typeof(AuditDataThreadRelatedEntity), (int)SD.HnD.DAL.EntityType.AuditDataThreadRelatedEntity);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<BookmarkEntity>>("PresentInBookmarks", a => a._presentInBookmarks, (a, b) => a._presentInBookmarks = b, a => a.PresentInBookmarks, () => new ThreadRelations().BookmarkEntityUsingThreadID, typeof(BookmarkEntity), (int)SD.HnD.DAL.EntityType.BookmarkEntity);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<MessageEntity>>("Messages", a => a._messages, (a, b) => a._messages = b, a => a.Messages, () => new ThreadRelations().MessageEntityUsingThreadID, typeof(MessageEntity), (int)SD.HnD.DAL.EntityType.MessageEntity);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<ThreadSubscriptionEntity>>("ThreadSubscription", a => a._threadSubscription, (a, b) => a._threadSubscription = b, a => a.ThreadSubscription, () => new ThreadRelations().ThreadSubscriptionEntityUsingThreadID, typeof(ThreadSubscriptionEntity), (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity);
				AddNavigatorMetaData<ThreadEntity, ForumEntity>("Forum", "Threads", (a, b) => a._forum = b, a => a._forum, (a, b) => a.Forum = b, SD.HnD.DAL.RelationClasses.StaticThreadRelations.ForumEntityUsingForumIDStatic, ()=>new ThreadRelations().ForumEntityUsingForumID, null, new int[] { (int)ThreadFieldIndex.ForumID }, null, true, (int)SD.HnD.DAL.EntityType.ForumEntity);
				AddNavigatorMetaData<ThreadEntity, UserEntity>("UserWhoStartedThread", "StartedThreads", (a, b) => a._userWhoStartedThread = b, a => a._userWhoStartedThread, (a, b) => a.UserWhoStartedThread = b, SD.HnD.DAL.RelationClasses.StaticThreadRelations.UserEntityUsingStartedByUserIDStatic, ()=>new ThreadRelations().UserEntityUsingStartedByUserID, null, new int[] { (int)ThreadFieldIndex.StartedByUserID }, null, true, (int)SD.HnD.DAL.EntityType.UserEntity);
				AddNavigatorMetaData<ThreadEntity, SupportQueueThreadEntity>("SupportQueueThread", "Thread", (a, b) => a._supportQueueThread = b, a => a._supportQueueThread, (a, b) => a.SupportQueueThread = b, SD.HnD.DAL.RelationClasses.StaticThreadRelations.SupportQueueThreadEntityUsingThreadIDStatic, ()=>new ThreadRelations().SupportQueueThreadEntityUsingThreadID, null, new int[] { (int)ThreadFieldIndex.ThreadID }, null, true, (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<UserEntity>>("UsersWhoBookmarkedThread", a => a._usersWhoBookmarkedThread, (a, b) => a._usersWhoBookmarkedThread = b, a => a.UsersWhoBookmarkedThread, () => new ThreadRelations().BookmarkEntityUsingThreadID, () => new BookmarkRelations().UserEntityUsingUserID, "ThreadEntity__", "Bookmark_", typeof(UserEntity), (int)SD.HnD.DAL.EntityType.UserEntity);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<UserEntity>>("UsersWhoPostedInThread", a => a._usersWhoPostedInThread, (a, b) => a._usersWhoPostedInThread = b, a => a.UsersWhoPostedInThread, () => new ThreadRelations().MessageEntityUsingThreadID, () => new MessageRelations().UserEntityUsingPostedByUserID, "ThreadEntity__", "Message_", typeof(UserEntity), (int)SD.HnD.DAL.EntityType.UserEntity);
				AddNavigatorMetaData<ThreadEntity, EntityCollection<UserEntity>>("UsersWhoSubscribedThread", a => a._usersWhoSubscribedThread, (a, b) => a._usersWhoSubscribedThread = b, a => a.UsersWhoSubscribedThread, () => new ThreadRelations().ThreadSubscriptionEntityUsingThreadID, () => new ThreadSubscriptionRelations().UserEntityUsingUserID, "ThreadEntity__", "ThreadSubscription_", typeof(UserEntity), (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
