...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _actionRight, new PropertyChangedEventHandler(OnActionRightPropertyChanged), "ActionRight", "ForumRoleForumActionRights", SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.ActionRightEntityUsingActionRightIDStatic, true, new int[] { (int)ForumRoleForumActionRightFieldIndex.ActionRightID });
		}
		...
		{
			SetupSync(relatedEntity, ref _actionRight, new PropertyChangedEventHandler( OnActionRightPropertyChanged ), "ActionRight", "ForumRoleForumActionRights", SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.ActionRightEntityUsingActionRightIDStatic, true, new string[] {  }, new int[] { (int)ForumRoleForumActionRightFieldIndex.ActionRightID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _forum, new PropertyChangedEventHandler(OnForumPropertyChanged), "Forum", "ForumRoleForumActionRights", SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.ForumEntityUsingForumIDStatic, true, new int[] { (int)ForumRoleForumActionRightFieldIndex.ForumID });
		}
		...
		{
			SetupSync(relatedEntity, ref _forum, new PropertyChangedEventHandler( OnForumPropertyChanged ), "Forum", "ForumRoleForumActionRights", SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.ForumEntityUsingForumIDStatic, true, new string[] {  }, new int[] { (int)ForumRoleForumActionRightFieldIndex.ForumID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _role, new PropertyChangedEventHandler(OnRolePropertyChanged), "Role", "ForumRoleForumActionRights", SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.RoleEntityUsingRoleIDStatic, true, new int[] { (int)ForumRoleForumActionRightFieldIndex.RoleID });
		}
		...
		{
			SetupSync(relatedEntity, ref _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", "ForumRoleForumActionRights", SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.RoleEntityUsingRoleIDStatic, true, new string[] {  }, new int[] { (int)ForumRoleForumActionRightFieldIndex.RoleID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ActionRightEntityFactory))),	(IEntityRelation)GetRelationsForField("ActionRight")[0], (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, (int)SD.HnD.DAL.EntityType.ActionRightEntity, 0, null, null, null, null, "ActionRight", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))),	(IEntityRelation)GetRelationsForField("Forum")[0], (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, (int)SD.HnD.DAL.EntityType.ForumEntity, 0, null, null, null, null, "Forum", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
