...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ForumRoleForumActionRightEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ForumRoleForumActionRightEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, typeof(ForumRoleForumActionRightEntity), typeof(ForumRoleForumActionRightEntityFactory), false);
				AddNavigatorMetaData<ForumRoleForumActionRightEntity, ActionRightEntity>("ActionRight", "ForumRoleForumActionRights", (a, b) => a._actionRight = b, a => a._actionRight, (a, b) => a.ActionRight = b, SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.ActionRightEntityUsingActionRightIDStatic, ()=>new ForumRoleForumActionRightRelations().ActionRightEntityUsingActionRightID, null, new int[] { (int)ForumRoleForumActionRightFieldIndex.ActionRightID }, null, true, (int)SD.HnD.DAL.EntityType.ActionRightEntity);
				AddNavigatorMetaData<ForumRoleForumActionRightEntity, ForumEntity>("Forum", "ForumRoleForumActionRights", (a, b) => a._forum = b, a => a._forum, (a, b) => a.Forum = b, SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.ForumEntityUsingForumIDStatic, ()=>new ForumRoleForumActionRightRelations().ForumEntityUsingForumID, null, new int[] { (int)ForumRoleForumActionRightFieldIndex.ForumID }, null, true, (int)SD.HnD.DAL.EntityType.ForumEntity);
				AddNavigatorMetaData<ForumRoleForumActionRightEntity, RoleEntity>("Role", "ForumRoleForumActionRights", (a, b) => a._role = b, a => a._role, (a, b) => a.Role = b, SD.HnD.DAL.RelationClasses.StaticForumRoleForumActionRightRelations.RoleEntityUsingRoleIDStatic, ()=>new ForumRoleForumActionRightRelations().RoleEntityUsingRoleID, null, new int[] { (int)ForumRoleForumActionRightFieldIndex.RoleID }, null, true, (int)SD.HnD.DAL.EntityType.RoleEntity);
			}
		}
