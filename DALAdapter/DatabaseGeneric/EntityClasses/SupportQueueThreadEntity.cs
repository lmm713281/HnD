...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		public IPredicateExpression ConstructFilterForUCThreadID()
		{
			...
			filter.Add(SD.HnD.DAL.HelperClasses.SupportQueueThreadFields.ThreadID == this.Fields.GetCurrentValue((int)SupportQueueThreadFieldIndex.ThreadID));
 			return filter;
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _supportQueue, new PropertyChangedEventHandler(OnSupportQueuePropertyChanged), "SupportQueue", "SupportQueueThreads", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.SupportQueueEntityUsingQueueIDStatic, true, new int[] { (int)SupportQueueThreadFieldIndex.QueueID });
		}
		...
		{
			SetupSync(relatedEntity, ref _supportQueue, new PropertyChangedEventHandler( OnSupportQueuePropertyChanged ), "SupportQueue", "SupportQueueThreads", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.SupportQueueEntityUsingQueueIDStatic, true, new string[] {  }, new int[] { (int)SupportQueueThreadFieldIndex.QueueID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _claimedByUser, new PropertyChangedEventHandler(OnClaimedByUserPropertyChanged), "ClaimedByUser", "SupportQueueThreadsClaimed", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.UserEntityUsingClaimedByUserIDStatic, true, new int[] { (int)SupportQueueThreadFieldIndex.ClaimedByUserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _claimedByUser, new PropertyChangedEventHandler( OnClaimedByUserPropertyChanged ), "ClaimedByUser", "SupportQueueThreadsClaimed", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.UserEntityUsingClaimedByUserIDStatic, true, new string[] {  }, new int[] { (int)SupportQueueThreadFieldIndex.ClaimedByUserID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _placedInQueueByUser, new PropertyChangedEventHandler(OnPlacedInQueueByUserPropertyChanged), "PlacedInQueueByUser", "SupportQueueThreadsPlaced", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.UserEntityUsingPlacedInQueueByUserIDStatic, true, new int[] { (int)SupportQueueThreadFieldIndex.PlacedInQueueByUserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _placedInQueueByUser, new PropertyChangedEventHandler( OnPlacedInQueueByUserPropertyChanged ), "PlacedInQueueByUser", "SupportQueueThreadsPlaced", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.UserEntityUsingPlacedInQueueByUserIDStatic, true, new string[] {  }, new int[] { (int)SupportQueueThreadFieldIndex.PlacedInQueueByUserID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _thread, new PropertyChangedEventHandler(OnThreadPropertyChanged), "Thread", "SupportQueueThread", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.ThreadEntityUsingThreadIDStatic, true, new int[] { (int)SupportQueueThreadFieldIndex.ThreadID });
		}
		...
		{
			SetupSync(relatedEntity, ref _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", "SupportQueueThread", SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  }, new int[] { (int)SupportQueueThreadFieldIndex.ThreadID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SupportQueueEntityFactory))),	(IEntityRelation)GetRelationsForField("SupportQueue")[0], (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, (int)SD.HnD.DAL.EntityType.SupportQueueEntity, 0, null, null, null, null, "SupportQueue", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("ClaimedByUser")[0], (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "ClaimedByUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("PlacedInQueueByUser")[0], (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "PlacedInQueueByUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))), (IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
