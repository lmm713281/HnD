...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SupportQueueThreadEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SupportQueueThreadEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, typeof(SupportQueueThreadEntity), typeof(SupportQueueThreadEntityFactory), false);
				AddNavigatorMetaData<SupportQueueThreadEntity, SupportQueueEntity>("SupportQueue", "SupportQueueThreads", (a, b) => a._supportQueue = b, a => a._supportQueue, (a, b) => a.SupportQueue = b, SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.SupportQueueEntityUsingQueueIDStatic, ()=>new SupportQueueThreadRelations().SupportQueueEntityUsingQueueID, null, new int[] { (int)SupportQueueThreadFieldIndex.QueueID }, null, true, (int)SD.HnD.DAL.EntityType.SupportQueueEntity);
				AddNavigatorMetaData<SupportQueueThreadEntity, UserEntity>("ClaimedByUser", "SupportQueueThreadsClaimed", (a, b) => a._claimedByUser = b, a => a._claimedByUser, (a, b) => a.ClaimedByUser = b, SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.UserEntityUsingClaimedByUserIDStatic, ()=>new SupportQueueThreadRelations().UserEntityUsingClaimedByUserID, null, new int[] { (int)SupportQueueThreadFieldIndex.ClaimedByUserID }, null, true, (int)SD.HnD.DAL.EntityType.UserEntity);
				AddNavigatorMetaData<SupportQueueThreadEntity, UserEntity>("PlacedInQueueByUser", "SupportQueueThreadsPlaced", (a, b) => a._placedInQueueByUser = b, a => a._placedInQueueByUser, (a, b) => a.PlacedInQueueByUser = b, SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.UserEntityUsingPlacedInQueueByUserIDStatic, ()=>new SupportQueueThreadRelations().UserEntityUsingPlacedInQueueByUserID, null, new int[] { (int)SupportQueueThreadFieldIndex.PlacedInQueueByUserID }, null, true, (int)SD.HnD.DAL.EntityType.UserEntity);
				AddNavigatorMetaData<SupportQueueThreadEntity, ThreadEntity>("Thread", "SupportQueueThread", (a, b) => a._thread = b, a => a._thread, (a, b) => a.Thread = b, SD.HnD.DAL.RelationClasses.StaticSupportQueueThreadRelations.ThreadEntityUsingThreadIDStatic, ()=>new SupportQueueThreadRelations().ThreadEntityUsingThreadID, null, new int[] { (int)SupportQueueThreadFieldIndex.ThreadID }, null, false, (int)SD.HnD.DAL.EntityType.ThreadEntity);
			}
		}
