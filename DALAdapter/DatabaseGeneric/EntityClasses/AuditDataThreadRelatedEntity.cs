...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class AuditDataThreadRelatedEntityStaticMetaData : AuditDataCoreEntityStaticMetaData
		{
			...
			{
				SetEntityCoreInfo("AuditDataThreadRelatedEntity", InheritanceHierarchyType.TargetPerEntity, true, (int)SD.HnD.DAL.EntityType.AuditDataThreadRelatedEntity, typeof(AuditDataThreadRelatedEntity), typeof(AuditDataThreadRelatedEntityFactory), false);
				AddNavigatorMetaData<AuditDataThreadRelatedEntity, ThreadEntity>("Thread", "AuditDataThreadRelated", (a, b) => a._thread = b, a => a._thread, (a, b) => a.Thread = b, SD.HnD.DAL.RelationClasses.StaticAuditDataThreadRelatedRelations.ThreadEntityUsingThreadIDStatic, ()=>new AuditDataThreadRelatedRelations().ThreadEntityUsingThreadID, null, new int[] { (int)AuditDataThreadRelatedFieldIndex.ThreadID }, null, true, (int)SD.HnD.DAL.EntityType.ThreadEntity);
			}
		}
