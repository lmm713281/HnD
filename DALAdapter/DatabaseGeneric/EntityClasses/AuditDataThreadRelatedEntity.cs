...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _thread, new PropertyChangedEventHandler(OnThreadPropertyChanged), "Thread", "AuditDataThreadRelated", SD.HnD.DAL.RelationClasses.StaticAuditDataThreadRelatedRelations.ThreadEntityUsingThreadIDStatic, true, new int[] { (int)AuditDataThreadRelatedFieldIndex.ThreadID });
		}
		...
		{
			SetupSync(relatedEntity, ref _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", "AuditDataThreadRelated", SD.HnD.DAL.RelationClasses.StaticAuditDataThreadRelatedRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  }, new int[] { (int)AuditDataThreadRelatedFieldIndex.ThreadID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.AuditDataThreadRelatedEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
