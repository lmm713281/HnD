...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class AttachmentEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AttachmentEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.AttachmentEntity, typeof(AttachmentEntity), typeof(AttachmentEntityFactory), false);
				AddNavigatorMetaData<AttachmentEntity, MessageEntity>("BelongsToMessage", "Attachments", (a, b) => a._belongsToMessage = b, a => a._belongsToMessage, (a, b) => a.BelongsToMessage = b, SD.HnD.DAL.RelationClasses.StaticAttachmentRelations.MessageEntityUsingMessageIDStatic, ()=>new AttachmentRelations().MessageEntityUsingMessageID, null, new int[] { (int)AttachmentFieldIndex.MessageID }, null, true, (int)SD.HnD.DAL.EntityType.MessageEntity);
			}
		}
