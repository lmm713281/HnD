...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _belongsToMessage, new PropertyChangedEventHandler(OnBelongsToMessagePropertyChanged), "BelongsToMessage", "Attachments", SD.HnD.DAL.RelationClasses.StaticAttachmentRelations.MessageEntityUsingMessageIDStatic, true, new int[] { (int)AttachmentFieldIndex.MessageID });
		}
		...
		{
			SetupSync(relatedEntity, ref _belongsToMessage, new PropertyChangedEventHandler( OnBelongsToMessagePropertyChanged ), "BelongsToMessage", "Attachments", SD.HnD.DAL.RelationClasses.StaticAttachmentRelations.MessageEntityUsingMessageIDStatic, true, new string[] {  }, new int[] { (int)AttachmentFieldIndex.MessageID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(MessageEntityFactory))),	(IEntityRelation)GetRelationsForField("BelongsToMessage")[0], (int)SD.HnD.DAL.EntityType.AttachmentEntity, (int)SD.HnD.DAL.EntityType.MessageEntity, 0, null, null, null, null, "BelongsToMessage", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
