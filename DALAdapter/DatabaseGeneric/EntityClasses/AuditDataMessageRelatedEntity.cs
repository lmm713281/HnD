...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class AuditDataMessageRelatedEntityStaticMetaData : AuditDataCoreEntityStaticMetaData
		{
			...
			{
				SetEntityCoreInfo("AuditDataMessageRelatedEntity", InheritanceHierarchyType.TargetPerEntity, true, (int)SD.HnD.DAL.EntityType.AuditDataMessageRelatedEntity, typeof(AuditDataMessageRelatedEntity), typeof(AuditDataMessageRelatedEntityFactory), false);
				AddNavigatorMetaData<AuditDataMessageRelatedEntity, MessageEntity>("Message", "AuditDataMessageRelated", (a, b) => a._message = b, a => a._message, (a, b) => a.Message = b, SD.HnD.DAL.RelationClasses.StaticAuditDataMessageRelatedRelations.MessageEntityUsingMessageIDStatic, ()=>new AuditDataMessageRelatedRelations().MessageEntityUsingMessageID, null, new int[] { (int)AuditDataMessageRelatedFieldIndex.MessageID }, null, true, (int)SD.HnD.DAL.EntityType.MessageEntity);
			}
		}
