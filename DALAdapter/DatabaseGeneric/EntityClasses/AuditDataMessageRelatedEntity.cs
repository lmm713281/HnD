...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _message, new PropertyChangedEventHandler(OnMessagePropertyChanged), "Message", "AuditDataMessageRelated", SD.HnD.DAL.RelationClasses.StaticAuditDataMessageRelatedRelations.MessageEntityUsingMessageIDStatic, true, new int[] { (int)AuditDataMessageRelatedFieldIndex.MessageID });
		}
		...
		{
			SetupSync(relatedEntity, ref _message, new PropertyChangedEventHandler( OnMessagePropertyChanged ), "Message", "AuditDataMessageRelated", SD.HnD.DAL.RelationClasses.StaticAuditDataMessageRelatedRelations.MessageEntityUsingMessageIDStatic, true, new string[] {  }, new int[] { (int)AuditDataMessageRelatedFieldIndex.MessageID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(MessageEntityFactory))),	(IEntityRelation)GetRelationsForField("Message")[0], (int)SD.HnD.DAL.EntityType.AuditDataMessageRelatedEntity, (int)SD.HnD.DAL.EntityType.MessageEntity, 0, null, null, null, null, "Message", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
