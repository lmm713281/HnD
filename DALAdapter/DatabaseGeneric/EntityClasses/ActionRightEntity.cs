...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumRoleForumActionRightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumRoleForumActionRightEntityFactory))), (IEntityRelation)GetRelationsForField("ForumRoleForumActionRights")[0], (int)SD.HnD.DAL.EntityType.ActionRightEntity, (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, 0, null, null, null, null, "ForumRoleForumActionRights", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RoleSystemActionRightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleSystemActionRightEntityFactory))), (IEntityRelation)GetRelationsForField("RoleSystemActionRights")[0], (int)SD.HnD.DAL.EntityType.ActionRightEntity, (int)SD.HnD.DAL.EntityType.RoleSystemActionRightEntity, 0, null, null, null, null, "RoleSystemActionRights", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSystemRightAssignedToRoles
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<RoleEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.ActionRightEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, GetRelationsForField("SystemRightAssignedToRoles"), null, "SystemRightAssignedToRoles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
