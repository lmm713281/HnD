...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _roleForAnonymous, new PropertyChangedEventHandler(OnRoleForAnonymousPropertyChanged), "RoleForAnonymous", "SystemDataAnonymousRole", SD.HnD.DAL.RelationClasses.StaticSystemDataRelations.RoleEntityUsingAnonymousRoleStatic, true, new int[] { (int)SystemDataFieldIndex.AnonymousRole });
		}
		...
		{
			SetupSync(relatedEntity, ref _roleForAnonymous, new PropertyChangedEventHandler( OnRoleForAnonymousPropertyChanged ), "RoleForAnonymous", "SystemDataAnonymousRole", SD.HnD.DAL.RelationClasses.StaticSystemDataRelations.RoleEntityUsingAnonymousRoleStatic, true, new string[] {  }, new int[] { (int)SystemDataFieldIndex.AnonymousRole }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _roleForNewUser, new PropertyChangedEventHandler(OnRoleForNewUserPropertyChanged), "RoleForNewUser", "SystemDataDefaultRoleNewUser", SD.HnD.DAL.RelationClasses.StaticSystemDataRelations.RoleEntityUsingDefaultRoleNewUserStatic, true, new int[] { (int)SystemDataFieldIndex.DefaultRoleNewUser });
		}
		...
		{
			SetupSync(relatedEntity, ref _roleForNewUser, new PropertyChangedEventHandler( OnRoleForNewUserPropertyChanged ), "RoleForNewUser", "SystemDataDefaultRoleNewUser", SD.HnD.DAL.RelationClasses.StaticSystemDataRelations.RoleEntityUsingDefaultRoleNewUserStatic, true, new string[] {  }, new int[] { (int)SystemDataFieldIndex.DefaultRoleNewUser }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("RoleForNewUser")[0], (int)SD.HnD.DAL.EntityType.SystemDataEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, null, null, "RoleForNewUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
