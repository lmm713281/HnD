...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SystemDataEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SystemDataEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.SystemDataEntity, typeof(SystemDataEntity), typeof(SystemDataEntityFactory), false);
				AddNavigatorMetaData<SystemDataEntity, RoleEntity>("RoleForAnonymous", "SystemDataAnonymousRole", (a, b) => a._roleForAnonymous = b, a => a._roleForAnonymous, (a, b) => a.RoleForAnonymous = b, SD.HnD.DAL.RelationClasses.StaticSystemDataRelations.RoleEntityUsingAnonymousRoleStatic, ()=>new SystemDataRelations().RoleEntityUsingAnonymousRole, null, new int[] { (int)SystemDataFieldIndex.AnonymousRole }, null, true, (int)SD.HnD.DAL.EntityType.RoleEntity);
				AddNavigatorMetaData<SystemDataEntity, RoleEntity>("RoleForNewUser", "SystemDataDefaultRoleNewUser", (a, b) => a._roleForNewUser = b, a => a._roleForNewUser, (a, b) => a.RoleForNewUser = b, SD.HnD.DAL.RelationClasses.StaticSystemDataRelations.RoleEntityUsingDefaultRoleNewUserStatic, ()=>new SystemDataRelations().RoleEntityUsingDefaultRoleNewUser, null, new int[] { (int)SystemDataFieldIndex.DefaultRoleNewUser }, null, true, (int)SD.HnD.DAL.EntityType.RoleEntity);
			}
		}
