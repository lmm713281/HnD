...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _thread, new PropertyChangedEventHandler(OnThreadPropertyChanged), "Thread", "ThreadSubscription", SD.HnD.DAL.RelationClasses.StaticThreadSubscriptionRelations.ThreadEntityUsingThreadIDStatic, true, new int[] { (int)ThreadSubscriptionFieldIndex.ThreadID });
		}
		...
		{
			SetupSync(relatedEntity, ref _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", "ThreadSubscription", SD.HnD.DAL.RelationClasses.StaticThreadSubscriptionRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  }, new int[] { (int)ThreadSubscriptionFieldIndex.ThreadID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "ThreadSubscription", SD.HnD.DAL.RelationClasses.StaticThreadSubscriptionRelations.UserEntityUsingUserIDStatic, true, new int[] { (int)ThreadSubscriptionFieldIndex.UserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "ThreadSubscription", SD.HnD.DAL.RelationClasses.StaticThreadSubscriptionRelations.UserEntityUsingUserIDStatic, true, new string[] {  }, new int[] { (int)ThreadSubscriptionFieldIndex.UserID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
