...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
				AddNavigatorMetaData<UserEntity, EntityCollection<AuditDataCoreEntity>>("LoggedAudits", a => a._loggedAudits, (a, b) => a._loggedAudits = b, a => a.LoggedAudits, () => new UserRelations().AuditDataCoreEntityUsingUserID, typeof(AuditDataCoreEntity), (int)SD.HnD.DAL.EntityType.AuditDataCoreEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<BookmarkEntity>>("Bookmarks", a => a._bookmarks, (a, b) => a._bookmarks = b, a => a.Bookmarks, () => new UserRelations().BookmarkEntityUsingUserID, typeof(BookmarkEntity), (int)SD.HnD.DAL.EntityType.BookmarkEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<IPBanEntity>>("IPBansSet", a => a._iPBansSet, (a, b) => a._iPBansSet = b, a => a.IPBansSet, () => new UserRelations().IPBanEntityUsingIPBanSetByUserID, typeof(IPBanEntity), (int)SD.HnD.DAL.EntityType.IPBanEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<MessageEntity>>("PostedMessages", a => a._postedMessages, (a, b) => a._postedMessages = b, a => a.PostedMessages, () => new UserRelations().MessageEntityUsingPostedByUserID, typeof(MessageEntity), (int)SD.HnD.DAL.EntityType.MessageEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<RoleUserEntity>>("RoleUser", a => a._roleUser, (a, b) => a._roleUser = b, a => a.RoleUser, () => new UserRelations().RoleUserEntityUsingUserID, typeof(RoleUserEntity), (int)SD.HnD.DAL.EntityType.RoleUserEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<SupportQueueThreadEntity>>("SupportQueueThreadsClaimed", a => a._supportQueueThreadsClaimed, (a, b) => a._supportQueueThreadsClaimed = b, a => a.SupportQueueThreadsClaimed, () => new UserRelations().SupportQueueThreadEntityUsingClaimedByUserID, typeof(SupportQueueThreadEntity), (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity);
				...
				AddNavigatorMetaData<UserEntity, EntityCollection<ThreadEntity>>("StartedThreads", a => a._startedThreads, (a, b) => a._startedThreads = b, a => a.StartedThreads, () => new UserRelations().ThreadEntityUsingStartedByUserID, typeof(ThreadEntity), (int)SD.HnD.DAL.EntityType.ThreadEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<ThreadSubscriptionEntity>>("ThreadSubscription", a => a._threadSubscription, (a, b) => a._threadSubscription = b, a => a.ThreadSubscription, () => new UserRelations().ThreadSubscriptionEntityUsingUserID, typeof(ThreadSubscriptionEntity), (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity);
				AddNavigatorMetaData<UserEntity, UserTitleEntity>("UserTitle", "Users", (a, b) => a._userTitle = b, a => a._userTitle, (a, b) => a.UserTitle = b, SD.HnD.DAL.RelationClasses.StaticUserRelations.UserTitleEntityUsingUserTitleIDStatic, ()=>new UserRelations().UserTitleEntityUsingUserTitleID, null, new int[] { (int)UserFieldIndex.UserTitleID }, null, true, (int)SD.HnD.DAL.EntityType.UserTitleEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<ForumEntity>>("StartedThreadsInForums", a => a._startedThreadsInForums, (a, b) => a._startedThreadsInForums = b, a => a.StartedThreadsInForums, () => new UserRelations().ThreadEntityUsingStartedByUserID, () => new ThreadRelations().ForumEntityUsingForumID, "UserEntity__", "Thread_", typeof(ForumEntity), (int)SD.HnD.DAL.EntityType.ForumEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<RoleEntity>>("Roles", a => a._roles, (a, b) => a._roles = b, a => a.Roles, () => new UserRelations().RoleUserEntityUsingUserID, () => new RoleUserRelations().RoleEntityUsingRoleID, "UserEntity__", "RoleUser_", typeof(RoleEntity), (int)SD.HnD.DAL.EntityType.RoleEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<ThreadEntity>>("ThreadsInBookmarks", a => a._threadsInBookmarks, (a, b) => a._threadsInBookmarks = b, a => a.ThreadsInBookmarks, () => new UserRelations().BookmarkEntityUsingUserID, () => new BookmarkRelations().ThreadEntityUsingThreadID, "UserEntity__", "Bookmark_", typeof(ThreadEntity), (int)SD.HnD.DAL.EntityType.ThreadEntity);
		...
		/// <remarks>Mapped on  table field: "User"."SignatureAsHTML".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 1024.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
