...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		public IPredicateExpression ConstructFilterForUCNickName()
		{
			...
			filter.Add(SD.HnD.DAL.HelperClasses.UserFields.NickName == this.Fields.GetCurrentValue((int)UserFieldIndex.NickName));
 			return filter;
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _userTitle, new PropertyChangedEventHandler(OnUserTitlePropertyChanged), "UserTitle", "Users", SD.HnD.DAL.RelationClasses.StaticUserRelations.UserTitleEntityUsingUserTitleIDStatic, true, new int[] { (int)UserFieldIndex.UserTitleID });
		}
		...
		{
			SetupSync(relatedEntity, ref _userTitle, new PropertyChangedEventHandler( OnUserTitlePropertyChanged ), "UserTitle", "Users", SD.HnD.DAL.RelationClasses.StaticUserRelations.UserTitleEntityUsingUserTitleIDStatic, true, new string[] {  }, new int[] { (int)UserFieldIndex.UserTitleID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditDataCoreEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditDataCoreEntityFactory))), (IEntityRelation)GetRelationsForField("LoggedAudits")[0], (int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.AuditDataCoreEntity, 0, null, null, null, null, "LoggedAudits", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BookmarkEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BookmarkEntityFactory))), (IEntityRelation)GetRelationsForField("Bookmarks")[0], (int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.BookmarkEntity, 0, null, null, null, null, "Bookmarks", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<MessageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MessageEntityFactory))), (IEntityRelation)GetRelationsForField("PostedMessages")[0], (int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.MessageEntity, 0, null, null, null, null, "PostedMessages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleUserEntityFactory))), (IEntityRelation)GetRelationsForField("RoleUser")[0], (int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.RoleUserEntity, 0, null, null, null, null, "RoleUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))), (IEntityRelation)GetRelationsForField("StartedThreads")[0], (int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "StartedThreads", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ThreadSubscriptionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ThreadSubscriptionEntityFactory))), (IEntityRelation)GetRelationsForField("ThreadSubscription")[0], (int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity, 0, null, null, null, null, "ThreadSubscription", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathStartedThreadsInForums
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ForumEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.ForumEntity, 0, null, null, GetRelationsForField("StartedThreadsInForums"), null, "StartedThreadsInForums", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathRoles
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<RoleEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, GetRelationsForField("Roles"), null, "Roles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathThreadsInBookmarks
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, GetRelationsForField("ThreadsInBookmarks"), null, "ThreadsInBookmarks", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPostedMessagesInThreads
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, GetRelationsForField("PostedMessagesInThreads"), null, "PostedMessagesInThreads", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathThreadCollectionViaThreadSubscription
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.UserEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, GetRelationsForField("ThreadCollectionViaThreadSubscription"), null, "ThreadCollectionViaThreadSubscription", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
