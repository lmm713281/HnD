...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditDataCoreEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditDataCoreEntityFactory))), (IEntityRelation)GetRelationsForField("AuditDataCore")[0], (int)SD.HnD.DAL.EntityType.AuditActionEntity, (int)SD.HnD.DAL.EntityType.AuditDataCoreEntity, 0, null, null, null, null, "AuditDataCore", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RoleAuditActionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleAuditActionEntityFactory))), (IEntityRelation)GetRelationsForField("RoleAuditActions")[0], (int)SD.HnD.DAL.EntityType.AuditActionEntity, (int)SD.HnD.DAL.EntityType.RoleAuditActionEntity, 0, null, null, null, null, "RoleAuditActions", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathRolesWithAuditAction
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<RoleEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.AuditActionEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, GetRelationsForField("RolesWithAuditAction"), null, "RolesWithAuditAction", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
