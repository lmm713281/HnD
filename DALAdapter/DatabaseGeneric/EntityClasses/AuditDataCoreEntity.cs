...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class AuditDataCoreEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AuditDataCoreEntity", InheritanceHierarchyType.TargetPerEntity, false, (int)SD.HnD.DAL.EntityType.AuditDataCoreEntity, typeof(AuditDataCoreEntity), typeof(AuditDataCoreEntityFactory), false);
				AddNavigatorMetaData<AuditDataCoreEntity, AuditActionEntity>("AuditAction", "AuditDataCore", (a, b) => a._auditAction = b, a => a._auditAction, (a, b) => a.AuditAction = b, SD.HnD.DAL.RelationClasses.StaticAuditDataCoreRelations.AuditActionEntityUsingAuditActionIDStatic, ()=>new AuditDataCoreRelations().AuditActionEntityUsingAuditActionID, null, new int[] { (int)AuditDataCoreFieldIndex.AuditActionID }, null, true, (int)SD.HnD.DAL.EntityType.AuditActionEntity);
				AddNavigatorMetaData<AuditDataCoreEntity, UserEntity>("UserAudited", "LoggedAudits", (a, b) => a._userAudited = b, a => a._userAudited, (a, b) => a.UserAudited = b, SD.HnD.DAL.RelationClasses.StaticAuditDataCoreRelations.UserEntityUsingUserIDStatic, ()=>new AuditDataCoreRelations().UserEntityUsingUserID, null, new int[] { (int)AuditDataCoreFieldIndex.UserID }, null, true, (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
