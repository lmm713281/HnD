...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _auditAction, new PropertyChangedEventHandler(OnAuditActionPropertyChanged), "AuditAction", "AuditDataCore", SD.HnD.DAL.RelationClasses.StaticAuditDataCoreRelations.AuditActionEntityUsingAuditActionIDStatic, true, new int[] { (int)AuditDataCoreFieldIndex.AuditActionID });
		}
		...
		{
			SetupSync(relatedEntity, ref _auditAction, new PropertyChangedEventHandler( OnAuditActionPropertyChanged ), "AuditAction", "AuditDataCore", SD.HnD.DAL.RelationClasses.StaticAuditDataCoreRelations.AuditActionEntityUsingAuditActionIDStatic, true, new string[] {  }, new int[] { (int)AuditDataCoreFieldIndex.AuditActionID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _userAudited, new PropertyChangedEventHandler(OnUserAuditedPropertyChanged), "UserAudited", "LoggedAudits", SD.HnD.DAL.RelationClasses.StaticAuditDataCoreRelations.UserEntityUsingUserIDStatic, true, new int[] { (int)AuditDataCoreFieldIndex.UserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _userAudited, new PropertyChangedEventHandler( OnUserAuditedPropertyChanged ), "UserAudited", "LoggedAudits", SD.HnD.DAL.RelationClasses.StaticAuditDataCoreRelations.UserEntityUsingUserIDStatic, true, new string[] {  }, new int[] { (int)AuditDataCoreFieldIndex.UserID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AuditActionEntityFactory))),	(IEntityRelation)GetRelationsForField("AuditAction")[0], (int)SD.HnD.DAL.EntityType.AuditDataCoreEntity, (int)SD.HnD.DAL.EntityType.AuditActionEntity, 0, null, null, null, null, "AuditAction", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("UserAudited")[0], (int)SD.HnD.DAL.EntityType.AuditDataCoreEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "UserAudited", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
