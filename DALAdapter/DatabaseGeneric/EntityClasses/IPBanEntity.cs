...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class IPBanEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("IPBanEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.IPBanEntity, typeof(IPBanEntity), typeof(IPBanEntityFactory), false);
				AddNavigatorMetaData<IPBanEntity, UserEntity>("SetByUser", "IPBansSet", (a, b) => a._setByUser = b, a => a._setByUser, (a, b) => a.SetByUser = b, SD.HnD.DAL.RelationClasses.StaticIPBanRelations.UserEntityUsingIPBanSetByUserIDStatic, ()=>new IPBanRelations().UserEntityUsingIPBanSetByUserID, new string[] { "SetByUserNickName" }, new int[] { (int)IPBanFieldIndex.IPBanSetByUserID }, a => a.OnSetByUserPropertyChanged, true, (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
