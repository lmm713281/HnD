...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _setByUser, new PropertyChangedEventHandler(OnSetByUserPropertyChanged), "SetByUser", "IPBansSet", SD.HnD.DAL.RelationClasses.StaticIPBanRelations.UserEntityUsingIPBanSetByUserIDStatic, true, new int[] { (int)IPBanFieldIndex.IPBanSetByUserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _setByUser, new PropertyChangedEventHandler( OnSetByUserPropertyChanged ), "SetByUser", "IPBansSet", SD.HnD.DAL.RelationClasses.StaticIPBanRelations.UserEntityUsingIPBanSetByUserIDStatic, true, new string[] { "SetByUserNickName" }, new int[] { (int)IPBanFieldIndex.IPBanSetByUserID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("SetByUser")[0], (int)SD.HnD.DAL.EntityType.IPBanEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "SetByUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
