...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class UserTitleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserTitleEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.UserTitleEntity, typeof(UserTitleEntity), typeof(UserTitleEntityFactory), false);
				AddNavigatorMetaData<UserTitleEntity, EntityCollection<UserEntity>>("Users", a => a._users, (a, b) => a._users = b, a => a.Users, () => new UserTitleRelations().UserEntityUsingUserTitleID, typeof(UserEntity), (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
