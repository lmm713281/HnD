...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RoleAuditActionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RoleAuditActionEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.RoleAuditActionEntity, typeof(RoleAuditActionEntity), typeof(RoleAuditActionEntityFactory), false);
				AddNavigatorMetaData<RoleAuditActionEntity, AuditActionEntity>("AuditAction", "RoleAuditActions", (a, b) => a._auditAction = b, a => a._auditAction, (a, b) => a.AuditAction = b, SD.HnD.DAL.RelationClasses.StaticRoleAuditActionRelations.AuditActionEntityUsingAuditActionIDStatic, ()=>new RoleAuditActionRelations().AuditActionEntityUsingAuditActionID, null, new int[] { (int)RoleAuditActionFieldIndex.AuditActionID }, null, true, (int)SD.HnD.DAL.EntityType.AuditActionEntity);
				AddNavigatorMetaData<RoleAuditActionEntity, RoleEntity>("Role", "RoleAuditAction", (a, b) => a._role = b, a => a._role, (a, b) => a.Role = b, SD.HnD.DAL.RelationClasses.StaticRoleAuditActionRelations.RoleEntityUsingRoleIDStatic, ()=>new RoleAuditActionRelations().RoleEntityUsingRoleID, null, new int[] { (int)RoleAuditActionFieldIndex.RoleID }, null, true, (int)SD.HnD.DAL.EntityType.RoleEntity);
			}
		}
