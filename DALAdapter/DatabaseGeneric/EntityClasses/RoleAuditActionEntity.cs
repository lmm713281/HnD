...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _auditAction, new PropertyChangedEventHandler(OnAuditActionPropertyChanged), "AuditAction", "RoleAuditActions", SD.HnD.DAL.RelationClasses.StaticRoleAuditActionRelations.AuditActionEntityUsingAuditActionIDStatic, true, new int[] { (int)RoleAuditActionFieldIndex.AuditActionID });
		}
		...
		{
			SetupSync(relatedEntity, ref _auditAction, new PropertyChangedEventHandler( OnAuditActionPropertyChanged ), "AuditAction", "RoleAuditActions", SD.HnD.DAL.RelationClasses.StaticRoleAuditActionRelations.AuditActionEntityUsingAuditActionIDStatic, true, new string[] {  }, new int[] { (int)RoleAuditActionFieldIndex.AuditActionID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _role, new PropertyChangedEventHandler(OnRolePropertyChanged), "Role", "RoleAuditAction", SD.HnD.DAL.RelationClasses.StaticRoleAuditActionRelations.RoleEntityUsingRoleIDStatic, true, new int[] { (int)RoleAuditActionFieldIndex.RoleID });
		}
		...
		{
			SetupSync(relatedEntity, ref _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", "RoleAuditAction", SD.HnD.DAL.RelationClasses.StaticRoleAuditActionRelations.RoleEntityUsingRoleIDStatic, true, new string[] {  }, new int[] { (int)RoleAuditActionFieldIndex.RoleID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AuditActionEntityFactory))),	(IEntityRelation)GetRelationsForField("AuditAction")[0], (int)SD.HnD.DAL.EntityType.RoleAuditActionEntity, (int)SD.HnD.DAL.EntityType.AuditActionEntity, 0, null, null, null, null, "AuditAction", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)SD.HnD.DAL.EntityType.RoleAuditActionEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
