...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))), (IEntityRelation)GetRelationsForField("DefaultForForums")[0], (int)SD.HnD.DAL.EntityType.SupportQueueEntity, (int)SD.HnD.DAL.EntityType.ForumEntity, 0, null, null, null, null, "DefaultForForums", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SupportQueueThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SupportQueueThreadEntityFactory))), (IEntityRelation)GetRelationsForField("SupportQueueThreads")[0], (int)SD.HnD.DAL.EntityType.SupportQueueEntity, (int)SD.HnD.DAL.EntityType.SupportQueueThreadEntity, 0, null, null, null, null, "SupportQueueThreads", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
