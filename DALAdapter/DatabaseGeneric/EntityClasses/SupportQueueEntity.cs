...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SupportQueueEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SupportQueueEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.SupportQueueEntity, typeof(SupportQueueEntity), typeof(SupportQueueEntityFactory), false);
				AddNavigatorMetaData<SupportQueueEntity, EntityCollection<ForumEntity>>("DefaultForForums", a => a._defaultForForums, (a, b) => a._defaultForForums = b, a => a.DefaultForForums, () => new SupportQueueRelations().ForumEntityUsingDefaultSupportQueueID, typeof(ForumEntity), (int)SD.HnD.DAL.EntityType.ForumEntity);
