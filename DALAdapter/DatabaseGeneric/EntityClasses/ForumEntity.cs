...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ForumEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ForumEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.ForumEntity, typeof(ForumEntity), typeof(ForumEntityFactory), false);
				AddNavigatorMetaData<ForumEntity, EntityCollection<ForumRoleForumActionRightEntity>>("ForumRoleForumActionRights", a => a._forumRoleForumActionRights, (a, b) => a._forumRoleForumActionRights = b, a => a.ForumRoleForumActionRights, () => new ForumRelations().ForumRoleForumActionRightEntityUsingForumID, typeof(ForumRoleForumActionRightEntity), (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity);
				AddNavigatorMetaData<ForumEntity, EntityCollection<ThreadEntity>>("Threads", a => a._threads, (a, b) => a._threads = b, a => a.Threads, () => new ForumRelations().ThreadEntityUsingForumID, typeof(ThreadEntity), (int)SD.HnD.DAL.EntityType.ThreadEntity);
				AddNavigatorMetaData<ForumEntity, SectionEntity>("Section", "Forums", (a, b) => a._section = b, a => a._section, (a, b) => a.Section = b, SD.HnD.DAL.RelationClasses.StaticForumRelations.SectionEntityUsingSectionIDStatic, ()=>new ForumRelations().SectionEntityUsingSectionID, null, new int[] { (int)ForumFieldIndex.SectionID }, null, true, (int)SD.HnD.DAL.EntityType.SectionEntity);
				AddNavigatorMetaData<ForumEntity, SupportQueueEntity>("DefaultSupportQueue", "DefaultForForums", (a, b) => a._defaultSupportQueue = b, a => a._defaultSupportQueue, (a, b) => a.DefaultSupportQueue = b, SD.HnD.DAL.RelationClasses.StaticForumRelations.SupportQueueEntityUsingDefaultSupportQueueIDStatic, ()=>new ForumRelations().SupportQueueEntityUsingDefaultSupportQueueID, null, new int[] { (int)ForumFieldIndex.DefaultSupportQueueID }, null, true, (int)SD.HnD.DAL.EntityType.SupportQueueEntity);
				AddNavigatorMetaData<ForumEntity, EntityCollection<UserEntity>>("UsersWhoStartedThreads", a => a._usersWhoStartedThreads, (a, b) => a._usersWhoStartedThreads = b, a => a.UsersWhoStartedThreads, () => new ForumRelations().ThreadEntityUsingForumID, () => new ThreadRelations().UserEntityUsingStartedByUserID, "ForumEntity__", "Thread_", typeof(UserEntity), (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
