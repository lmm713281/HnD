...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _section, new PropertyChangedEventHandler(OnSectionPropertyChanged), "Section", "Forums", SD.HnD.DAL.RelationClasses.StaticForumRelations.SectionEntityUsingSectionIDStatic, true, new int[] { (int)ForumFieldIndex.SectionID });
		}
		...
		{
			SetupSync(relatedEntity, ref _section, new PropertyChangedEventHandler( OnSectionPropertyChanged ), "Section", "Forums", SD.HnD.DAL.RelationClasses.StaticForumRelations.SectionEntityUsingSectionIDStatic, true, new string[] {  }, new int[] { (int)ForumFieldIndex.SectionID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _defaultSupportQueue, new PropertyChangedEventHandler(OnDefaultSupportQueuePropertyChanged), "DefaultSupportQueue", "DefaultForForums", SD.HnD.DAL.RelationClasses.StaticForumRelations.SupportQueueEntityUsingDefaultSupportQueueIDStatic, true, new int[] { (int)ForumFieldIndex.DefaultSupportQueueID });
		}
		...
		{
			SetupSync(relatedEntity, ref _defaultSupportQueue, new PropertyChangedEventHandler( OnDefaultSupportQueuePropertyChanged ), "DefaultSupportQueue", "DefaultForForums", SD.HnD.DAL.RelationClasses.StaticForumRelations.SupportQueueEntityUsingDefaultSupportQueueIDStatic, true, new string[] {  }, new int[] { (int)ForumFieldIndex.DefaultSupportQueueID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumRoleForumActionRightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumRoleForumActionRightEntityFactory))), (IEntityRelation)GetRelationsForField("ForumRoleForumActionRights")[0], (int)SD.HnD.DAL.EntityType.ForumEntity, (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, 0, null, null, null, null, "ForumRoleForumActionRights", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))), (IEntityRelation)GetRelationsForField("Threads")[0], (int)SD.HnD.DAL.EntityType.ForumEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, null, "Threads", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUsersWhoStartedThreads
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.ForumEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, GetRelationsForField("UsersWhoStartedThreads"), null, "UsersWhoStartedThreads", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
