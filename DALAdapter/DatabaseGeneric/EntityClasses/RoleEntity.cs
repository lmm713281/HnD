...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumRoleForumActionRightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumRoleForumActionRightEntityFactory))), (IEntityRelation)GetRelationsForField("ForumRoleForumActionRights")[0], (int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity, 0, null, null, null, null, "ForumRoleForumActionRights", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RoleAuditActionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleAuditActionEntityFactory))), (IEntityRelation)GetRelationsForField("RoleAuditAction")[0], (int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.RoleAuditActionEntity, 0, null, null, null, null, "RoleAuditAction", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RoleSystemActionRightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleSystemActionRightEntityFactory))), (IEntityRelation)GetRelationsForField("RoleSystemActionRights")[0], (int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.RoleSystemActionRightEntity, 0, null, null, null, null, "RoleSystemActionRights", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RoleUserEntityFactory))), (IEntityRelation)GetRelationsForField("RoleUser")[0], (int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.RoleUserEntity, 0, null, null, null, null, "RoleUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SystemDataEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SystemDataEntityFactory))), (IEntityRelation)GetRelationsForField("SystemDataAnonymousRole")[0], (int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.SystemDataEntity, 0, null, null, null, null, "SystemDataAnonymousRole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAssignedSystemActionRights
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ActionRightEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionRightEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.ActionRightEntity, 0, null, null, GetRelationsForField("AssignedSystemActionRights"), null, "AssignedSystemActionRights", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAssignedAuditActions
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<AuditActionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditActionEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.AuditActionEntity, 0, null, null, GetRelationsForField("AssignedAuditActions"), null, "AssignedAuditActions", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUsers
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), intermediateRelation,
					(int)SD.HnD.DAL.EntityType.RoleEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, GetRelationsForField("Users"), null, "Users", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
