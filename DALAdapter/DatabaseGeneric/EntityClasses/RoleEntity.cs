...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RoleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RoleEntity", InheritanceHierarchyType.None, false, (int)SD.HnD.DAL.EntityType.RoleEntity, typeof(RoleEntity), typeof(RoleEntityFactory), false);
				AddNavigatorMetaData<RoleEntity, EntityCollection<ForumRoleForumActionRightEntity>>("ForumRoleForumActionRights", a => a._forumRoleForumActionRights, (a, b) => a._forumRoleForumActionRights = b, a => a.ForumRoleForumActionRights, () => new RoleRelations().ForumRoleForumActionRightEntityUsingRoleID, typeof(ForumRoleForumActionRightEntity), (int)SD.HnD.DAL.EntityType.ForumRoleForumActionRightEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<RoleAuditActionEntity>>("RoleAuditAction", a => a._roleAuditAction, (a, b) => a._roleAuditAction = b, a => a.RoleAuditAction, () => new RoleRelations().RoleAuditActionEntityUsingRoleID, typeof(RoleAuditActionEntity), (int)SD.HnD.DAL.EntityType.RoleAuditActionEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<RoleSystemActionRightEntity>>("RoleSystemActionRights", a => a._roleSystemActionRights, (a, b) => a._roleSystemActionRights = b, a => a.RoleSystemActionRights, () => new RoleRelations().RoleSystemActionRightEntityUsingRoleID, typeof(RoleSystemActionRightEntity), (int)SD.HnD.DAL.EntityType.RoleSystemActionRightEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<RoleUserEntity>>("RoleUser", a => a._roleUser, (a, b) => a._roleUser = b, a => a.RoleUser, () => new RoleRelations().RoleUserEntityUsingRoleID, typeof(RoleUserEntity), (int)SD.HnD.DAL.EntityType.RoleUserEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<SystemDataEntity>>("SystemDataAnonymousRole", a => a._systemDataAnonymousRole, (a, b) => a._systemDataAnonymousRole = b, a => a.SystemDataAnonymousRole, () => new RoleRelations().SystemDataEntityUsingAnonymousRole, typeof(SystemDataEntity), (int)SD.HnD.DAL.EntityType.SystemDataEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<SystemDataEntity>>("SystemDataDefaultRoleNewUser", a => a._systemDataDefaultRoleNewUser, (a, b) => a._systemDataDefaultRoleNewUser = b, a => a.SystemDataDefaultRoleNewUser, () => new RoleRelations().SystemDataEntityUsingDefaultRoleNewUser, typeof(SystemDataEntity), (int)SD.HnD.DAL.EntityType.SystemDataEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<ActionRightEntity>>("AssignedSystemActionRights", a => a._assignedSystemActionRights, (a, b) => a._assignedSystemActionRights = b, a => a.AssignedSystemActionRights, () => new RoleRelations().RoleSystemActionRightEntityUsingRoleID, () => new RoleSystemActionRightRelations().ActionRightEntityUsingActionRightID, "RoleEntity__", "RoleSystemActionRight_", typeof(ActionRightEntity), (int)SD.HnD.DAL.EntityType.ActionRightEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<AuditActionEntity>>("AssignedAuditActions", a => a._assignedAuditActions, (a, b) => a._assignedAuditActions = b, a => a.AssignedAuditActions, () => new RoleRelations().RoleAuditActionEntityUsingRoleID, () => new RoleAuditActionRelations().AuditActionEntityUsingAuditActionID, "RoleEntity__", "RoleAuditAction_", typeof(AuditActionEntity), (int)SD.HnD.DAL.EntityType.AuditActionEntity);
				AddNavigatorMetaData<RoleEntity, EntityCollection<UserEntity>>("Users", a => a._users, (a, b) => a._users = b, a => a.Users, () => new RoleRelations().RoleUserEntityUsingRoleID, () => new RoleUserRelations().UserEntityUsingUserID, "RoleEntity__", "RoleUser_", typeof(UserEntity), (int)SD.HnD.DAL.EntityType.UserEntity);
			}
		}
