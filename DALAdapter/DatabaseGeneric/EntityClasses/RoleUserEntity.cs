...
namespace SD.HnD.DAL.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _role, new PropertyChangedEventHandler(OnRolePropertyChanged), "Role", "RoleUser", SD.HnD.DAL.RelationClasses.StaticRoleUserRelations.RoleEntityUsingRoleIDStatic, true, new int[] { (int)RoleUserFieldIndex.RoleID });
		}
		...
		{
			SetupSync(relatedEntity, ref _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", "RoleUser", SD.HnD.DAL.RelationClasses.StaticRoleUserRelations.RoleEntityUsingRoleIDStatic, true, new string[] {  }, new int[] { (int)RoleUserFieldIndex.RoleID }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "RoleUser", SD.HnD.DAL.RelationClasses.StaticRoleUserRelations.UserEntityUsingUserIDStatic, true, new int[] { (int)RoleUserFieldIndex.UserID });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "RoleUser", SD.HnD.DAL.RelationClasses.StaticRoleUserRelations.UserEntityUsingUserIDStatic, true, new string[] {  }, new int[] { (int)RoleUserFieldIndex.UserID }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)SD.HnD.DAL.EntityType.RoleUserEntity, (int)SD.HnD.DAL.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DAL.EntityType.RoleUserEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
