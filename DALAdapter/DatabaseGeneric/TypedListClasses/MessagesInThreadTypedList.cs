...
namespace SD.HnD.DAL.TypedListClasses
{
	...
	public partial class MessagesInThreadTypedList : TypedListBase2<MessagesInThreadRow>, ITypedListLgp2
			...
			
	{
		...
		private void BuildRelationSet()
		{
			...
			_filterBucket.Relations.Add(UserEntity.Relations.MessageEntityUsingPostedByUserID, "", "", JoinHint.Right);
			_filterBucket.Relations.Add(UserTitleEntity.Relations.UserEntityUsingUserTitleID, "", "", JoinHint.Inner);
		...
		private void BuildResultset()
		{
			...
			_fields.DefineField(MessageFields.PostedFromIP, 4, "PostedFromIP", "", AggregateFunction.None);
			_fields.DefineField(UserFields.UserID, 5, "UserID", "", AggregateFunction.None);
			_fields.DefineField(UserFields.NickName, 6, "NickName", "", AggregateFunction.None);
			_fields.DefineField(UserFields.SignatureAsHTML, 7, "SignatureAsHTML", "", AggregateFunction.None);
			_fields.DefineField(UserFields.IconURL, 8, "IconURL", "", AggregateFunction.None);
			_fields.DefineField(UserFields.Location, 9, "Location", "", AggregateFunction.None);
			_fields.DefineField(UserFields.JoinDate, 10, "JoinDate", "", AggregateFunction.None);
			_fields.DefineField(UserFields.AmountOfPostings, 11, "AmountOfPostings", "", AggregateFunction.None);
			_fields.DefineField(UserTitleFields.UserTitleDescription, 12, "UserTitleDescription", "", AggregateFunction.None);
			...
			
	{
		...
		/// <summary>Gets / sets the value of the TypedList field PostedFromIP<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field UserID<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field SignatureAsHTML<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field IconURL<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field Location<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field JoinDate<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field AmountOfPostings<br/><br/></summary>
		...
		/// <summary>Gets / sets the value of the TypedList field UserTitleDescription<br/><br/></summary>
